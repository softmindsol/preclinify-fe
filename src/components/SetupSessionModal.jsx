        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center overflow-y-auto '>
          ...
          >
            ...
            <div className='mb-6 mt-8'>
              <p className='block text-[#52525B] font-medium text-[20px] mb-2 dark:text-white'>
                Question Type
              </p>
                ...
                <div className='space-y-20' key={type}>
                  <div className='flex items-center justify-between mb-10 mt-5'>
                    ...
                    <input
                      ...
                      className={`mr-2 w-6 h-6 appearance-none border-2 rounded-md border-gray-200   checked:bg-[#3CC8A1] checked:border-[#3CC8A1] cursor-pointer`}
                    />
                  </div>
                </div>
              ))}
            ...
            <div className='absolute left-5 right-5 bottom-3 '>
              <button
                ...
                className={`py-2 ${
                  isLoading || isLoadingShortQuestion || isQuesGenLoading || isMockLoading
                    ? 'bg-[#82c7b4]'
                    : 'bg-[#3CC8A1]'
                } ${
                  isLoading ||
                ...
                } w-[100%] text-[16px] font-semibold text-white rounded-[8px] hover:bg-[#2e9e7e] dark:text-white`}
                disabled={
                  isLoading || isLoadingShortQuestion || isQuesGenLoading || isMockLoading
                }
              >
