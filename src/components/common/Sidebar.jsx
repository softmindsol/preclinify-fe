...
const Sidebar = () => {
  ...
  return (
    <div
      className={`min-h-screen w-64 bg-white shadow-lg  dark:border-[#3A3A48] dark:border-r-[1px] flex flex-col items-center py-6 dark:bg-[#1E1E2A] text-black `}
    >
      {/* Logo */}
      <div className='mb-10'>
        <Link to={'/'}>
      ...
      <nav className='space-y-8 w-full text-[#3F3F46] '>
        {[
          ...
          <div key={index}>
            <NavLink
              to={item.id}
              className='flex items-center space-x-3 px-6 group cursor-pointer dark:text-white'
            >
              <svg
