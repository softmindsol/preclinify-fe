              ...
              <SwiperSlide>
                <div className='flex  items-center justify-center gap-x-24 '>
                      <img src="https://images.unsplash.com/photo-1733299703906-29f25913ee6e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyM3x8fGVufDB8fHx8fA%3D%3D" alt="" 
                       />
                      <div className='text-[#3F3F46] w-[640px] text-[16px] xl:text-[20px] 2xl:text-[24px] font-medium text-center'>
                        <p>
                        ...
                        <p>
                          ...
                          <p className='text-[16px] xl:text-[20px] 2xl:text-[24px] text-[#FF9741] ' style={{marginTop:'10px'}}>
