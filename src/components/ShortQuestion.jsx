    ...
    <div className={`min-h-screen  ${darkModeRedux ? 'dark' : ''} `}>
      ...
      <div className='  h-screen  flex items-center justify-center   dark:bg-[#1E1E2A]  '>
        <div className='w-[100%] h-screen max-w-full  md:w-[80%] lg:w-[70%] xl:w-[55%]  '>
          ...
          <div className='mt-6  p-6 '>
            ...
            {!testCheckAnswer ? (
              <div>
                <textarea
                  className={`rounded-[6px] w-[100%] lg:w-[720px] h-[180px] mt-2  p-5 text-wrap border border-[#ffff] placeholder:text-[#D4D4D8] placeholder:text-[14px] placeholder:font-normal ${
                ...
                />
                {error ? (
                  <p className='text-red-500 text-[12px]'>Please enter your answer</p>
                ) : (
                  <p></p>
                )}
              </div>
              ...
              <div className='sm:space-x-5 flex-wrap md:space-x-10 lg:space-x-3  flex items-center  '>
                {review ? (
                  ...
                  <div className='sm:space-x-5 flex-wrap md:space-x-5 lg:space-x-3 flex items-center lg:justify-start justify-center w-[100%] '>
                    <button
                      className='bg-[#EF4444] w-[150px] lg:w-[230px] text-[#FFFF] p-2 rounded-[8px]'
                      onClick={handleIncorrectClick}
                    >
                      Incorrect{' '}
                      <span className='bg-[#F4F4F5] p-1.5 rounded-[4px] font-medium text-[#27272A] ml-2'>
                        1
                      </span>
                    </button>
                    <button
                      className='bg-[#FF9741] w-[150px] lg:w-[230px] text-[#FFFF] p-2 rounded-[8px]'
                      onClick={handlePartialClick}
                    >
                      Partial{' '}
                      <span className='bg-[#F4F4F5] p-1 rounded-[4px] font-medium text-[#27272A] ml-2'>
                        2
                      </span>
                    </button>
                    <button
                      className='bg-[#3CC8A1] w-[150px] lg:w-[230px] text-[#FFFF] p-2 rounded-[8px]'
            ...
            {isReviewEnabled && (
              <div
                className={`flex items-center w-[100%] lg:w-[720px] font-semibold gap-x-2 ${
                  isFinishEnabled
        ...
        <div className={`hidden lg:block fixed right-0 top-0 dark:border  `}>
          <div
            className={` bg-white w-[28%] md:w-[25%] lg:w-[240px] flex flex-col items-center justify-between  h-screen dark:bg-[#1E1E2A] text-black   ${
          ...
          <div
            className={`absolute right-0 top-0 bg-white w-[28%] md:w-[25%] lg:w-[50px]   h-screen ${
              !toggleSidebar && 'translate-x-full'
            } transition-transform duration-300  dark:bg-[#1E1E2A] text-black  dark:border-[1px] dark:border-[#3A3A48]`}
          >
            <div
            ...
            >
              <svg
                ...
                stroke-linecap='round'
                stroke-linejoin='round'
                class='lucide lucide-chevrons-right mt-5 ml-3 dark:text-white'
              >
      ...
      {isAccordionVisible && (
        <div className='flex items-center gap-x-96 justify-center  w-[100%] md:w-[70%] xl:w-[55%] 2xl:w-[90%] '>
          <p className='font-medium text-[16px] text-[#3F3F46]'>
        ...
        <div className=' bg-white    h-screen '>
            ...
            <div className='w-[90%] 2xl:w-[308px] h-[96px] rounded-[8px] bg-[#3CC8A1] text-[#ffff] text-center'>
              {isTimerMode === 'Endless' ? (
                ...
                <div>
                  ...
                  <p className='font-black text-[36px]'>{<p>{formatTime(timer)}</p>}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className='flex items-center justify-center gap-x-28 mt-3 text-[#71717A]'>
            ...
            <button
              ...
              onClick={
                (currentPage + 1) * itemsPerPage < currentItems.length ? nextPage : null
              }
