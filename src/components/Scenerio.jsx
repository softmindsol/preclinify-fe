...
import { fetchModules, fetchOSCEData } from "../redux/features/osce-static/osce-static.service";
            ...
            <div className="dark:bg-[#1E1E2A] md:ml-[250px] w-full px-10">
                <div className="mt-8">
                    <div className="flex justify-center w-full items-center gap-x-2 text-[14px] lg:text-[16px] xl:text-[20px]">
                        ...
                        <div
                            className={`flex justify-center w-full items-center space-x-4 rounded-tl-[4px] ${activeTab === "static" ? "bg-[#FAFAFA]" : "bg-[#E4E4E7]"
                        ...
                        <div
                            className={`flex justify-center w-full items-center rounded-tr-[4px] ${activeTab === "ai" ? "bg-[#FAFAFA]" : "bg-[#E4E4E7]"
                                } dark:border dark:bg-[#1E1E2A] dark:border-[#3A3A48]`}
                        >
                            <button
                                ...
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-10 ">
                                    {filteredData.map((osce, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <Link to={activeTab === "static" ? `/static-scenerios-detail/${osce.id}` : `/ai-patient-scenarios-detail/${osce.id}`}>
                                                    <div className="flex flex-col h-full justify-between">
                                                        ...
                                                        <div className="text-[48px] text-[#52525B] font-bold dark:text-white">#{osce.module}</div>
                                                    </div>
                                                </Link>
                                            </div>
                                        );
                                        ...
                                        {filteredData.map((osce, i) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className="p-4 bg-[#F4F4F5] hover:opacity-75 cursor-pointer relative rounded-[8px] w-[172px] shadow-md text-center dark:bg-[#1E1E2A] border dark:border-[#3A3A48]"
                                                >
                                                    <Link to={activeTab === "static" ? `/static-scenerios-detail/${osce.id}` : `/osce-ai-bot/${categoryName.replace(/\s+/g, "-")}`}>
                                                        <div className="flex flex-col h-full justify-between">
                                                            <div>
                                                                <p className="absolute top-1 right-2 text-[12px] font-semibold text-[#A1A1AA] lg:text-[14px] dark:text-white">
                                                                    {osce.category}
                            ...
                            >
                                ...
                                >
                                    ...
                                    {item.icon === "book-open" && (
                                        <>
                                            <path d="M12 7v14" />
                                            <path d="M3 18a1 1 0 0 1-1-1V4a1 ```javascript
