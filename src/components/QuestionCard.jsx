        ...
        <div className={` min-h-screen  ${darkModeRedux ? 'dark' : ''}   `}>
            <div className='dark:bg-[#1E1E2A] min-h-screen'>
                ...
                <div className=' mx-auto  flex items-center justify-center p-6  text-black   '>
                    <div
                        className={`max-w-full  transition-all duration-150  w-[100%] md:w-[80%] lg:w-[70%] xl:w-[55%] ${toggleSidebar ? '2xl:w-[55%] ' : '2xl:w-[40%] '
                    ...
                    >
                        ...
                        <div className='bg-[#3CC8A1]   text-white p-6 rounded-md flex items-center justify-between relative'>
                            ...
                            <div className='flex items-center space-x-4 absolute left-1/2 transform -translate-x-1/2 text-[14px] lg:text-[18px]'>
                                <button
                                    className={`text-white ${currentIndex + 1 <= 1 ? 'opacity-70 cursor-not-allowed' : ''
                                        }`}
                  ...
                  {data?.mcqsByModulesData[currentIndex].questionStem}
                                ...
                                {!isReviewEnabled &&
                                    (isAccordionVisible ? (
                                        ...
                                        <div className='group'>
                                            <button
                                                className={` mt-2 text-[14px] flex items-center justify-center gap-x-3 w-full lg:text-[16px] bg-[#3CC8A1] text-white px-6 py-2 rounded-md font-semibold transition-all duration-300 ease-in-out  ${isAnswered && 'hover:bg-transparent'
                                                    }  ${isAnswered && 'hover:text-[#3CC8A1]'
                                                    }  border border-[#3CC8A1] ${!isAnswered && 'cursor-not-allowed'
                                                    }`}
                                            ...
                                            >
                                                Check Answer
                                                <span
                                                    className={`bg-white rounded-[4px] px-[2px]  ${isAnswered && 'group-hover:bg-[#3CC8A1]'
                                                ...
                                                >
                                                    <svg
                                                        ...
                                                        strokeLinecap='round'
                                                        strokeLinejoin='round'
                                                        className={`lucide lucide-space text-black  ${isAnswered && 'group-hover:text-white'
                                                            } transition-all duration-300 ease-in-out`}
                                                    >
                                                        <path d='M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1' />
                                                    </svg>
                    ...
                    <div className={`hidden lg:block fixed right-0 top-0`}>
                            ...
                            <div className='w-full'>
                                ...
                                <div className='flex flex-col items-center justify-center mt-10'>
                                    {isTimerMode['mode'] === 'Endless' && (
                                        <div
                                            className={`w-[90%] h-[96px] rounded-[8px] bg-[#3CC8A1] ${mcqsAccuracy > 34 ? 'bg-[#3CC8A1]' : 'bg-[#FF453A]'
                        ...
                        <div
                            className={`absolute right-0 top-0 bg-white w-[28%] md:w-[25%] lg:w-[50px] 3A3A48 dark:border-[1px] dark:border-[#3A3A48] h-screen ${!toggleSidebar && 'translate-x-full'
