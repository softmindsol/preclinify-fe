...
const Dashboard = () => {
  ...
  return (
    <>
      {
        dashboardLoading ? (<div className="flex items-center justify-center h-screen">
          <Loader />
        </div>) : (
                      ...
                      <div className="xs:w-[420px] h-[430px] w-[95%] rounded-lg bg-white p-5 text-black shadow-md dark:border-[1px] dark:border-[#3A3A48] dark:bg-[#1E1E2A] md:h-[520px] xl:w-[610px] 2xl:w-[745px]">
                        <div className="flex items-end justify-end">
                          <div className="relative mb-5 w-[180px]">
                            ...
                            />
                            <span
                              className={`pointer-events-none absolute right-10 top-1/2 -translate-y-1/2 transform transition-transform duration-200 dark:text-white sm:right-3 ${isCalendarOpen ? "rotate-180" : ""
                                }`}
                            >
                              <svg
