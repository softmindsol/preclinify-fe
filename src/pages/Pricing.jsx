    ...
    return (
        <div className='overflow-hidden'>
            ...
            <div className='flex flex-col items-center justify-center h-screen mt-16 overflow-hidden '>
                <div className='font-semibold text-[36px]  text-[#52525B] text-center'>
                    <p className='leading-[60px]'>So confident </p>
                ...
                <div>
                    <div className='flex items-center justify-center gap-x-5'>
                        <div className='mt-5 relative  transition hover:shadow-greenBlur rounded-[16px]'>
                            <div className='h-[556px] w-[310px] border-[1px] border-[#3CC8A1] rounded-[16px]'>
                                <div className='h-[140px] w-full bg-[#3CC8A1] text-center rounded-tr-[14px] rounded-tl-[14px] p-5'>
                                    <p className='text-white font-bold text-[20px]'>The OSCE plan</p>
                                    <p className='text-white font-extrabold text-[40px]'>£84</p>
                                </div>
                                <div className='p-8 space-y-2'>
                                    <div className='flex items-center gap-x-5'>
                                        <IoMdCheckmarkCircleOutline color='#FF9741' size={20} />
                                        <p className='font-medium text-[#3F3F46] text-[18px] w-[60%]'>
                                            Station specific
                                            OSCE scenarios
                                        </p>
                                    </div>
                                    <div className='flex items-center gap-x-5'>
                                        <IoMdCheckmarkCircleOutline color='#FF9741' size={20} />
                                        <p className='font-medium text-[#3F3F46] text-[18px] w-[65%]'>
                                            60 hours of OSCE
                                            bot access
                                        </p>
                                    </div>
                        ...
                        <div className='mt-5 relative  transition hover:shadow-greenBlur rounded-[16px]'>
                            <div className='h-[556px] w-[310px] border-[1px] border-[#3CC8A1] rounded-[16px]'>
                                <div className='h-[140px] w-full bg-[#3CC8A1] text-center rounded-tr-[14px] rounded-tl-[14px] p-5'>
                                    <p className='text-white font-bold text-[20px]'>The Full Package</p>
                                    <p className='text-white font-extrabold text-[40px]'>£120</p>
                                </div>
                                <div className='p-8 space-y-2 text-[16px]'>
                                    <div className='flex items-center gap-x-5'>
                                        <IoMdCheckmarkCircleOutline color='#FF9741' size={20} />
                        ...
                        <div className='mt-5 relative  transition hover:shadow-greenBlur rounded-[16px]'>
                            <div className='h-[556px] w-[310px] border-[1px] border-[#3CC8A1] rounded-[16px]'>
                                <div className='h-[140px] w-full bg-[#3CC8A1] text-center rounded-tr-[14px] rounded-tl-[14px] p-5'>
                                    <p className='text-white font-bold text-[20px]'>The Pass Guarentee</p>
                                    <p className='text-white font-extrabold text-[40px]'>£1,280</p>
                                </div>
                                <div className='p-8 space-y-2'>
                                    <div className='flex items-center gap-x-5'>
                                        <IoMdCheckmarkCircleOutline color='#FF9741' size={20} />
