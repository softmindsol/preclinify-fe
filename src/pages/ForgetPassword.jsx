    ...
    return (
        <div className='flex items-center  w-full'>
            <div className='bg-[#FFFFFF] h-screen flex items-center justify-center gap-y-5 flex-col w-[50%]'>
                <Logo />
                <p className='text-[24px] leading-[29px] font-medium text-[#3F3F46]'>Forget Password</p>
                <form action="" className='mt-2 space-y-3'>
                    ...
                    <div>
                        <button className='w-[430px] h-[50px] rounded-[8px] bg-[#FFE9D6] text-[#FF9741] font-medium hover:bg-[#e3863a] hover:text-white transition-all duration-150'>Continue</button>
                    </div>
